<?php
	...
	function inventoryOutForm($con)
	{
		...
		$query = "SELECT `idInventoryOut` FROM `inventoryout` WHERE `Date`='$newDate' ORDER BY `idInventoryOut` DESC  LIMIT 1";
